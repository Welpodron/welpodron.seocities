...
//     "welpodron:seocities.admin.seo.items",
//     "",
//     array(
...
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        'PATH_TO_ADD' => BX_ROOT . '/admin/welpodron.seocities.seo.item.php?ID=0&lang=' . LANGUAGE_ID,
        'PATH_TO_EDIT' => BX_ROOT . '/admin/welpodron.seocities.seo.item.php?ID=#id#&lang=' . LANGUAGE_ID,
        'PATH_TO_EXPORT' => BX_ROOT . '/admin/welpodron.seocities.seo.export.php?ID=#id#&lang=' . LANGUAGE_ID,
        'PATH_TO_IMPORT' => BX_ROOT . '/admin/welpodron.seocities.seo.import.php?lang=' . LANGUAGE_ID,
        'CAN_EDIT' => $canEdit,
        'ADMIN_MODE' => true
    )
);
